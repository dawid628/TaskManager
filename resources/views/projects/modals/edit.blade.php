<div id="editProjectModal" class="fixed inset-0 bg-black/60 backdrop-blur-sm hidden overflow-y-auto h-full w-full z-50">
    <div class="relative top-20 mx-auto p-6 border border-zinc-700 w-96 shadow-2xl rounded-xl bg-zinc-800">
        <div class="flex justify-between items-center mb-6">
            <h3 class="text-xl font-bold text-zinc-100">Edit Project</h3>
        ...
        <form id="editProjectForm" method="POST">
            ...
            <div class="mb-6">
                <label for="edit_project_name" class="block text-zinc-300 font-semibold mb-2">
                    Project Name *
                </label>
                <input type="text"
                       name="name"
